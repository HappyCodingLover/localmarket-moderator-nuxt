        ...
        <div class="root">
            ...
            >
                        ...
                        <v-row class="pt-0">
                            ...
                            >
                                <v-btn
                                    ...
                                    text
                                    @click="
                                        rejectRequest('company_address', newItem.id)
                                    "
                                >
                                    Отклонить
                                </v-btn>
                                <v-btn
                                    ...
                                    color="green"
                                    @click="
                                        approveRequest('company_address', newItem.id)
                                    "
                                    >Принять</v-btn
                                >
                            </v-col>
                ...
                <v-tab-item>
                    ...
                    <v-row class="pt-5" v-if="oldItem">
                        <v-col lg="6" md="12" sm="12">
                            <p class="mb-2">Основной адрес</p>
                            <v-text-field
                                readonly
                                v-model="oldItem.address"
                                hide-details
                                outlined
                                dense
                                color="#414042"
...
export default {
    ...
    created() {
        this.$store
            .dispatch("getCompanyAddressRequestById", this.requestId)
            .then((resp) => {
                if (resp && resp.new) {
