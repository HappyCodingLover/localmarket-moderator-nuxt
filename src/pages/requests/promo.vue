                        ...
                        <v-row class="pt-0">
                            ...
                            >
                                <v-btn
                                    ...
                                    text
                                    @click="
                                        rejectRequest('promo', newItem.id)
                                    "
                                >
                                    Отклонить
                                </v-btn>
                                <v-btn
                                    ...
                                    color="green"
                                    @click="
                                        approveRequest('promo', newItem.id)
                                    "
                                    >Принять</v-btn
                                >
                            </v-col>
...
export default {
    ...
    created() {
        this.$store
            .dispatch("getPromoRequestById", this.requestId)
            .then((resp) => {
                if (resp && resp.new) {
